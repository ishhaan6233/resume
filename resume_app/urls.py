...
urlpatterns = [
    ...
    path("responses/edit/<int:response_id>/", views.edit_response, name="edit_response"),
    path("responses/delete/<int:response_id>/", views.delete_response, name="delete_response"),
    
    # Resume CRUD
    path("resumes/add/", views.add_resume, name="add_resume"),
    path("resumes/edit/<int:resume_id>/", views.edit_resume, name="edit_resume"),
    path("resumes/delete/<int:resume_id>/", views.delete_resume, name="delete_resume"),
    path("resumes/set-active/<int:resume_id>/", views.set_active_resume, name="set_active_resume"),
]
