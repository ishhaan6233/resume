...
class Response(models.Model):
    ...
    job_application = models.ForeignKey(JobApplication, on_delete=models.CASCADE, related_name='responses', null=True, blank=True)
    company = models.CharField(max_length=255)
    position = models.CharField(max_length=255)
...
class ApplicationCategory(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='application_categories')
